...
source.include_exts = py,png,jpg,kv,atlas,json,ini,txt
...
requirements = python3,kivy,gspread,urllib3,google,google-api-python-client,google-api-core,google-auth,google-auth-oauthlib,googleapis-common-protos,cachetools,pyasn1,pyasn1-modules,rsa,requests-oauthlib,oauthlib,StrEnum,requests
